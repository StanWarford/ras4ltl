...
\item Publication of the ACM paper sparks interest in proving every theorem in the paper using an automated theorem prover, thus confirming the correctness of the theorems and the proofs.\\

\item This had been done earlier using ACL2, but the task was never completed or published until recently\cite{PP1}. This task was repeated and completed by the first author and is presented here for the first time.\\
